...
#     def __init__(self, layer=9, n_mat = 6, requires_grad=False):
...
#         for x in range(layer): #9,16 (35 for vgg19)
...
#         else:
#             #https://discuss.pytorch.org/t/how-to-normalize-all-feature-maps-to-a-range-of-0-1/96753/6
